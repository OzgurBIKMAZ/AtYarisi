    ...
    public partial class AtYarisi : Form
    {
        ...
        private void MenuDiger_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                YarisReset();
                AtIsimYukle(yarisAyak-1, listeAtlar);
            }
        }
        ...
        private void MenuSonuc_Click(object sender, EventArgs e)
        {
            ...
            else if (listeYarisSonuc.Count == 6)
            {
                               ...
                               int zorlukPist, int yarisAyak, List<string> sonucListesi)
        {
            ...
            string atIsim = ((AtIsim)listeAtlar[yarisAyak - 1][atID - 1]).ToString();
        ...
        private void AtIsimYukle(int ayak, List<int[]> atSecim)
        {
            lbl1.Text = ((AtIsim)atSecim[ayak][0]).ToString();
            lbl2.Text = ((AtIsim)atSecim[ayak][1]).ToString();
            lbl3.Text = ((AtIsim)atSecim[ayak][2]).ToString();
            lbl4.Text = ((AtIsim)atSecim[ayak][3]).ToString();
            lbl5.Text = ((AtIsim)atSecim[ayak][4]).ToString();
            lbl6.Text = ((AtIsim)atSecim[ayak][5]).ToString();
        }
